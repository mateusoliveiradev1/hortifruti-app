...
export async function POST(request: Request) {
  try {
    ...
    if (escalaExistente && forcar) {
      // A opção onDelete: Cascade no schema do Prisma deve cuidar de deletar os registros relacionados
    ...
    // 3. Buscar as regras ativas do banco
    ...
    // Salvar todos os turnos de uma vez (MUITO mais rápido!)
